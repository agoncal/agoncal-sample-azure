...
public class HandOfCards extends SpecificRecordBase implements SpecificRecord {
    ...
    private java.util.List<PlayingCard> cards;
     ...
     */
    public HandOfCards(java.util.List<PlayingCard> cards) {
        this.cards = cards;
    }
    ...
    public void put(int field$, Object value$) {
        switch (field$) {
            case 0:
                cards = (java.util.List<PlayingCard>) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
     ...
     */
    public java.util.List<PlayingCard> getCards() {
        return cards;
    }
     ...
     */
    public void setCards(java.util.List<PlayingCard> value) {
        this.cards = value;
    }
     ...
     */
    public static HandOfCards.Builder newBuilder() {
        return new HandOfCards.Builder();
    }
     ...
     * @return A new HandOfCards RecordBuilder
     */
    public static HandOfCards.Builder newBuilder(HandOfCards.Builder other) {
        if (other == null) {
            return new HandOfCards.Builder();
        } else {
            return new HandOfCards.Builder(other);
        }
    }
     ...
     * @return A new HandOfCards RecordBuilder
     */
    public static HandOfCards.Builder newBuilder(HandOfCards other) {
        if (other == null) {
            return new HandOfCards.Builder();
        } else {
            return new HandOfCards.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<HandOfCards>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(HandOfCards.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(HandOfCards other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.cards)) {
                this.cards = data().deepCopy(fields()[0].schema(), other.cards);
         ...
         * @return This builder.
         */
        public HandOfCards.Builder setCards(java.util.List<PlayingCard> value) {
         ...
         * @return This builder.
         */
        public HandOfCards.Builder clearCards() {
            cards = null;
        ...
        public HandOfCards build() {
            try {
                ...
                record.cards = fieldSetFlags()[0] ? this.cards : (java.util.List<PlayingCard>) defaultValue(fields()[0]);
                return record;
    ...
    public void customDecode(org.apache.avro.io.ResolvingDecoder in)
        ...
        if (fieldOrder == null) {
            ...
            java.util.List<PlayingCard> a0 = this.cards;
            if (a0 == null) {
                a0 = new SpecificData.Array<PlayingCard>((int) size0, SCHEMA$.getField("cards").schema());
                this.cards = a0;
            } else a0.clear();
            SpecificData.Array<PlayingCard> ga0 = (a0 instanceof SpecificData.Array ? (SpecificData.Array<PlayingCard>) a0 : null);
            for (; 0 < size0; size0 = in.arrayNext()) {
                for (; size0 != 0; size0--) {
                    PlayingCard e0 = (ga0 != null ? ga0.peek() : null);
                    if (e0 == null) {
                        e0 = new PlayingCard();
                    }
                    e0.customDecode(in);
