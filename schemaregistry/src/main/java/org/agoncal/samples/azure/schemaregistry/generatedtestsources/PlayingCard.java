...
public class PlayingCard extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
    ...
    private PlayingCardSuit playingCardSuit;
     ...
     */
    public PlayingCard(Boolean isFaceCard, Integer cardValue, PlayingCardSuit playingCardSuit) {
    ...
    public void put(int field$, Object value$) {
        switch (field$) {
            case 0:
                isFaceCard = (Boolean) value$;
                break;
            case 1:
                cardValue = (Integer) value$;
                break;
            case 2:
                playingCardSuit = (PlayingCardSuit) value$;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
     ...
     * @param value the value to set.
     */
    public void setPlayingCardSuit(PlayingCardSuit value) {
     ...
     */
    public static PlayingCard.Builder newBuilder() {
        return new PlayingCard.Builder();
    }
     ...
     * @return A new PlayingCard RecordBuilder
     */
    public static PlayingCard.Builder newBuilder(PlayingCard.Builder other) {
        if (other == null) {
            return new PlayingCard.Builder();
        } else {
            return new PlayingCard.Builder(other);
        }
    }
     ...
     * @return A new PlayingCard RecordBuilder
     */
    public static PlayingCard.Builder newBuilder(PlayingCard other) {
        if (other == null) {
            return new PlayingCard.Builder();
        } else {
            return new PlayingCard.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<PlayingCard>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(PlayingCard.Builder other) {
            super(other);
         ...
         * @param other The existing instance to copy.
         */
        private Builder(PlayingCard other) {
            super(SCHEMA$);
            if (isValidValue(fields()[0], other.isFaceCard)) {
                this.isFaceCard = data().deepCopy(fields()[0].schema(), other.isFaceCard);
         ...
         * @return This builder.
         */
        public PlayingCard.Builder setIsFaceCard(boolean value) {
         ...
         * @return This builder.
         */
        public PlayingCard.Builder clearIsFaceCard() {
         ...
         * @return This builder.
         */
        public PlayingCard.Builder setCardValue(int value) {
         ...
         * @return This builder.
         */
        public PlayingCard.Builder clearCardValue() {
         ...
         * @return This builder.
         */
        public PlayingCard.Builder setPlayingCardSuit(PlayingCardSuit value) {
         ...
         * @return This builder.
         */
        public PlayingCard.Builder clearPlayingCardSuit() {
        ...
        public PlayingCard build() {
            try {
                ...
                record.isFaceCard = fieldSetFlags()[0] ? this.isFaceCard : (Boolean) defaultValue(fields()[0]);
                record.cardValue = fieldSetFlags()[1] ? this.cardValue : (Integer) defaultValue(fields()[1]);
                record.playingCardSuit = fieldSetFlags()[2] ? this.playingCardSuit : (PlayingCardSuit) defaultValue(fields()[2]);
                return record;
    ...
    public void customDecode(org.apache.avro.io.ResolvingDecoder in)
        ...
        if (fieldOrder == null) {
            ...
            this.playingCardSuit = PlayingCardSuit.values()[in.readEnum()];
