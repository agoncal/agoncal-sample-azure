...
public class Person2 extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
     ...
     */
    public Person2(String name, Integer favourite_number, String favourite_colour, String favourite_pet) {
        this.name = name;
    ...
    public void put(int field$, Object value$) {
        switch (field$) {
            ...
            case 2:
                ...
                break;
            case 3:
                favourite_pet = value$ != null ? value$.toString() : null;
                break;
            default:
                throw new IndexOutOfBoundsException("Invalid index: " + field$);
        }
     ...
     * @param value the value to set.
     */
    public void setFavouritePet(String value) {
     ...
     */
    public static Person2.Builder newBuilder() {
        return new Person2.Builder();
    }
     ...
     * @return A new Person2 RecordBuilder
     */
    public static Person2.Builder newBuilder(Person2.Builder other) {
        if (other == null) {
            return new Person2.Builder();
        } else {
            return new Person2.Builder(other);
        }
    }
     ...
     * @return A new Person2 RecordBuilder
     */
    public static Person2.Builder newBuilder(Person2 other) {
        if (other == null) {
            return new Person2.Builder();
        } else {
            return new Person2.Builder(other);
    ...
    public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Person2>
         ...
         * @param other The existing Builder to copy.
         */
        private Builder(Person2.Builder other) {
            super(other);
         ...
         * @return This builder.
         */
        public Person2.Builder setName(String value) {
         ...
         * @return This builder.
         */
        public Person2.Builder clearName() {
            name = null;
         ...
         * @return This builder.
         */
        public Person2.Builder setFavouriteNumber(Integer value) {
         ...
         * @return This builder.
         */
        public Person2.Builder clearFavouriteNumber() {
         ...
         * @return This builder.
         */
        public Person2.Builder setFavouriteColour(String value) {
         ...
         * @return This builder.
         */
        public Person2.Builder clearFavouriteColour() {
         ...
         * @return This builder.
         */
        public Person2.Builder setFavouritePet(String value) {
         ...
         * @return This builder.
         */
        public Person2.Builder clearFavouritePet() {
            favourite_pet = null;
        ...
        public Person2 build() {
            try {
                ...
                record.favourite_pet = fieldSetFlags()[3] ? this.favourite_pet : (String) defaultValue(fields()[3]);
                return record;
